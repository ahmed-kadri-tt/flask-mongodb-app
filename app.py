...
mongodb_username = os.environ.get('MONGO_USERNAME', 'my-user')
mongodb_password = os.environ.get('MONGO_PASSWORD', 'ahmed123')
mongodb_host = os.environ.get('MONGO_HOST', 'ahmed123')
